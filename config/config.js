...
define([], function () {
    ...
    var config = UccelloClass.extend({
        ...
        controls: [
            ...
            { className: 'MetaObjTreeElemRoot', isUccello: true, component: 'metaData/metaObjTreeElemRoot', metaType: ['sys', 'client'] },
            { className: 'MetaObjTreeElem', isUccello: true, component: 'metaData/metaObjTreeElem', metaType: ['sys', 'client'] },
            { className: 'MetaObjTree', isUccello: true, component: 'metaData/metaObjTree', metaType: ['sys', 'client'] },
        ...
        classGuids: {
            ...
            'MetaObjTreeElemRoot': "f0138eab-8a62-4cb8-b9f5-33917bec1f59",
            'MetaObjTreeElem': "85f03964-5ea7-4743-9c8e-549110f1c154",
            'MetaObjTree': "c0d078c7-1c7b-4fd1-a8b0-b9f09eea31f8",
