define(
    ...
    function(template, tpl) {
        ...
        vDBTreeNavigator.render = function (options) {
            ...
            if (editor.length === 0) {
                ...
                editor.find('.dragRight').click(function () {
                    vDBTreeNavigator.toParent.apply(that);
                });
                // перейти к чайлду
                editor.find('.dragLeft').click(function () {
                    vDBTreeNavigator.toChild.apply(that);
                });
                // рефреш
        ...
        vDBTreeNavigator.toParent = function (vcomp) {
            ...
            var link = leftTpl.find('a')
                ...
                .click(function () {
                    ...
                    left.find('a').removeClass('active');
                    a.addClass('active');
                    vDBTreeNavigator.selectItem.apply(that, [a.data('obj'), 0]);
                    return false;
                });
            left.append(leftTpl);
            link.click();
        ...
        vDBTreeNavigator.toChild = function (vcomp) {
                ...
                for (var i = 0, len = obj.countCol(); i < len; i++) {
                    ...
                    var link = centerTpl.find('a')
                        ...
                        .click(function () {
                            ...
                            a.addClass('active');
                            vDBTreeNavigator.selectCol.apply(that, [a.data('obj'), level]);
                            return false;
                        });
