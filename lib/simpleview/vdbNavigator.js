    ...
    function(template, tpl) {
        ...
        vDBNavigator.tranButton = function () {
            ...
            if (db && "getTranList" in db) {
                ...
                var table = $('<table></table>'), thTable = $('<tr><td colspan="10"><input type="button" value="truncate" /></td> </tr><tr><th>guid</th><th>start</th><th>end</th><th>state</th><th>src</th></tr>');
        ...
        vDBNavigator.verHistButton = function () {
            ...
            if (db && rootElem) {
                ...
                var table = $('<table></table>'), thTable = $('<tr><th>version</th><th>guid</th><th>start</th><th>end</th><th>state</th><th>src</th></tr>');
                table.append(thTable);
                var index=0;
