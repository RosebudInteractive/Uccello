    ...
    function(template, tpl) {
        ...
        vDBNavigator.renderTable = function (db, tranList, type) {
            ...
            for(var i in tranList) {
                ...
                var start = vDBNavigator.timeFormat(tran.start), end = tran.end?tran.end:null, pend=tran.pend?tran.pend:null;
                ...
                for(var j in tran.roots) {
                    if (index!=0) {
                        var tr = $('<tr></tr>');
                        tr.append(type == 'tran'?'<td></td><td></td><td></td><td></td><td></td><td></td>':'<td></td><td></td><td></td><td></td><td></td><td></td><td></td>');
                    }
                    if (type == 'tran')
                        tr.append('<td title="'+j+'">'+vDBNavigator.getRootName.apply(this, [j])+'</td>');
        ...
        vDBNavigator.timeFormat = function (date) {
            if (!date) return null;
