    ...
    function(template, tpl) {
        ...
        vDBNavigator.renderTable = function (db, tranList, type) {
            ...
            if (type == 'tran') {
                ...
                thTable =  $('<tr><th>version</th><th>guid</th><th>tran guid</th><th>start</th><th>p-duration</th><th>c-duration</th><th>state</th><th>src</th><th>rootGuid</th><th>min</th><th>max</th></tr>');
            }
